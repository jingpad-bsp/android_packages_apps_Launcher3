...
public final class FeatureOption {
    ...
    public static final TogglableFlag SPRD_MULTI_MODE_SUPPORT = new TogglableFlag(
            "SPRD_MULTI_MODE_SUPPORT", getProp("ro.launcher.multimode", true),
    ...
    public static final boolean SPRD_GESTURE_ENABLE = getProp("ro.launcher.gesture", false);
    ...
    public static final TogglableFlag SPRD_CYCLE_SCROLL_SUPPORT = new TogglableFlag(
            "SPRD_CYCLE_SCROLL_SUPPORT", getProp("ro.launcher.cyclescroll", false),
    ...
    public static final TogglableFlag SPRD_TASK_LOCK_SUPPORT = new TogglableFlag(
            "SPRD_TASK_LOCK_SUPPORT", getProp("ro.launcher.tasklock", false),
